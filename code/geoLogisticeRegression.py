...
def main():
    ...
    sess = tf.Session()
    #sess.run(init)
    saver.restore(sess, "/home-nfs/jiajun/Research/GeoRegression/code/logistic_model.ckpt")
    ...
    for i in range(80000):
        ...
        if i % 500 == 0:
            ...
            print("=======================================================================================")
        if i % 5000 == 0:
            save_path = saver.save(sess, "/home-nfs/jiajun/Research/GeoRegression/code/logistic_model.ckpt")
