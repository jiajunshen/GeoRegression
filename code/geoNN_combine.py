...
def main():
    ...
    for i in range(num_region):
        ...
        for neighbor in neighbors:
            constraint_loss += tf.reduce_sum(tf.square(tf.sub(w_1_list[i], w_1_list[neighbor - 1])))
            constraint_loss += tf.reduce_sum(tf.square(tf.sub(w_2_list[i], w_2_list[neighbor - 1])))
    ...
    checkpoint_filepath = "/home-nfs/jiajun/Research/GeoRegression/code/NN_model_combine.ckpt"
    ...
    for i in range(80000):
        ...
        if i % 500 == 0:
            ...
            print("constraint loss", constraint_loss_value)
            ...
            print("=======================================================================================")
        if i % 5000 == 0:
            save_path = saver.save(sess, "/home-nfs/jiajun/Research/GeoRegression/code/NN_model_combine.ckpt")
